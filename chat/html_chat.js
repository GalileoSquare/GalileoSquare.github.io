...
function htmljs_Chat_Init( holder )
{
    ...
    var html =  "<div class=\"holder-html-chat\" >"
		  ...
		  + "<input type=\"text\" id=\"WebChatNameID\" class=\"html-chat-js-name\"  placeholder=\"Укажите ваше имя...\" >"
	          + "<textarea id = \"WebChatTextID\" placeholder = \"Отправте сообщение в глобальный онлайн чат...\" class=\"html-chat-js-input\" ></textarea>"

                  + "<div class=\"html-chat-js-button-holder\">"
                  +    "<input type=\"button\"  onclick=\"web_send_msg();\" value=\"Отправить\" >"
                  +    " <div class=\"html-chat-js-answer\"  ><a href=\"https://comet-server.com\" id=\"answer\" target='__blank' ></a></div>"
                  + "</div>"
             +  "</div>";
    $(holder).html(html);
    ...
    // РџСЂРѕСЃРёРј РѕС‚РїСЂР°РІРёС‚СЊ РїРѕСЃР»РµРґРЅРёРµ СЃРѕРѕР±С‰РµРЅРёСЏ РєРѕС‚РѕСЂС‹Рµ Р±С‹Р»Рё РѕС‚РїСЂР°РІР»РµРЅС‹ РІ РєР°РЅР°Р». РС‚Рѕ РїРѕР·РІРѕР»РёС‚ Р·Р°РіСЂСѓР·РёС‚СЊ РёСЃС‚РѕСЂРёСЋ СЃРѕРѕР±С‰РµРЅРёР№ РІ С‡Р°С‚.    
